...
class NewEventFormTest(TestCase):
    ...
    #---------------------------------------------------------------------------
    def test_freq(self):
        e = Event.objects.create(title='FIRE BAD!', description='***')
...
class CreationTest(TestCase):
    ...
    def test_1(self):
        ...
        e = Event.objects.create(title='Hello, world', description='Happy New Year')
    ...
    def test_2(self):
        ...
        e = create_event('Bicycle repairman')
    ...
    def test_6(self):
        ...
        e = Event.objects.create(title='Yet another event', description="with tons of occurrences")
        self.assertEqual(e.get_absolute_url(), '/events/{}/'.format(e.id))
